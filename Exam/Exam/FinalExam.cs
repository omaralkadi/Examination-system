...
namespace Exam
{
    internal class FinalExam : Exaam //mcq and true and false Questions
    {
        public FinalExam(double timeOfExam, int numOfQuestion) : base(timeOfExam, numOfQuestion)
        {
        ...
        public override Question[] FillExam()
        {
            ...
            question.InserDataOfQuestions(ques, 1);
            return ques;
        ...
        public override void StartExam(Question[] ques)
        {
            ...
            {
                Console.WriteLine($"{ques[i].Header} \n{ques[i].Body}");
                Console.WriteLine($"Correct Answer: {ques[i].CorrectAnswer}");
                Console.WriteLine("-----------------------------------------------------------");
